    ...
    <div class="container">
      <nav class="level is-mobile docs-nav">
        ...
        <div class="level-right">
          ...
          <div
            class="level-item is-hidden-tablet"
            @click="startSearch"
          >
            <b-icon icon="search" />
          </div>
...
export default {
  ...
  watch: {
    sourceChoice(source) {
      if (this.$route.params.source !== source) {
        this.$router.push({ name: "docs-source", params: { source } });
      }
    },
    tagChoice(tag) {
    ...
    $route(to) {
      ...
      if (to.params.tag && this.tagChoice !== to.params.tag) {
        this.tagChoice = to.params.tag;
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    startSearch() {
      ...
      if (this.$route.name !== "docs-search") {
        this.$router.replace({
          name: "docs-search",
          query: { q: this.search }
        });
