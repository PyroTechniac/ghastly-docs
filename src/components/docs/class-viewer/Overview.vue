        ...
        <aside class="menu">
          ...
          <ul class="menu-list">
            <li
              ...
              :key="`${scopedName(property)}-property`"
              class="animated-list-item"
            >
              <router-link :to="{ name: 'docs-class', query: { scrollTo: scopedName(property) } }">
                {{ property.name }}
                <span v-if="property.scope === 'static'">
                  <span class="tag is-primary is-pulled-right">S</span>&nbsp;
                </span>
                <span v-if="property.readonly">
                  <span class="tag is-success is-pulled-right">R</span>&nbsp;
                </span>
                <span v-if="property.abstract">
                  <span class="tag is-info is-pulled-right">A</span>&nbsp;
                </span>
                <span v-if="property.deprecated">
                  <span class="tag is-danger is-pulled-right">D</span>&nbsp;
                </span>
                <span v-if="property.access === 'private'">
                  <span class="tag is-warning is-pulled-right">P</span>&nbsp;
                </span>
              </router-link>
            </li>
          </ul>
            ...
            >
              <router-link :to="{ name: 'docs-class', query: { scrollTo: scopedName(method) } }">
                ...
                <span v-if="method.async">
                  <span class="tag is-success is-pulled-right">A</span>&nbsp;
                </span>
                ...
                <span v-if="method.generator">
                  <span class="tag is-dark is-pulled-right">G</span>&nbsp;
                </span>
              </router-link>
            </li>
          </ul>
